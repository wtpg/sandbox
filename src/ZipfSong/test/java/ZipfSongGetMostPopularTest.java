...
/**
 * ZipfSong#getMostPopular() unit test
 */
@RunWith(Parameterized.class)
public class ZipfSongGetMostPopularTest {
    private ZipfSong[] input;
    private String[] expected;

    public ZipfSongGetMostPopularTest(ZipfSong[] input, String[] expected) {
        this.input = input;
    ...
    public static Collection params()  {
        ...
        String[] expected1 = new String[] {"four", "two"};
        ...
        String[] expected2 = new String[] {"19_2000", "clint_eastwood", "tomorrow_comes_today"};
    ...
    public void testGetMostPopular() throws Exception {
        String[] result = ZipfSong.getMostPopular(Arrays.asList(input), expected.length);
